...
* include the **vsdatatable-0.0.4.min.js** and the **vsdatatable-0.0.4.min.css** files into your project. See the **Build project** and the **Installation** chapters below.
```html
<script src="vsdatatable-0.0.4.min.js"></script>
<link href="vsdatatable-0.0.4.min.css" rel="stylesheet" type="text/css">
```
