 ...
 */
sampleapp.controller('sampleappctrl', function ($scope, $http, vsdatatableConfig, vsdatatableEvent, vsdatatableConfig) {
    ...
    $scope.opt = {
        ...
        templates: {
            add: {path: 'demo/partials/template/add_edit.html', actionBtnShow: true, btnTooltip: 'Add'},
