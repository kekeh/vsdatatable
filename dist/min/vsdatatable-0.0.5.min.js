...
angular.module("vsdatatable", ["template-vsdatatable-0.0.5.html"]).constant("vsdatatableConfig", {
...
}]).service("vsdatatableService", ["$http", "$templateCache", "vsdatatableConfig", function (a, b, c) {
    var d = {};
...
}).directive("overlayWindow", ["$compile", "$timeout", "vsdatatableService", function (a, b, c) {
    return {
...
}]).directive("vstooltip", ["$compile", "$timeout", "vsdatatableService", function (a, b, c) {
    return {
        restrict: "A", scope: !1, link: function (d, e, f) {
            function g() {
                n = b(function () {
