...
angular.module("vsdatatable", ["template-vsdatatable-0.1.0.html"]).constant("vsdtConf", {
    ...
    return {
        ...
        controller: ["$scope", function (a) {
            a.config = c, a.colInitDone = !1, a.colTogglerShow = !1, a.busyIcon = !1, a.filteredItems = [], a.selectedRows = [], a.totalCount = 0, a.sort = {
                col: "",
                reverse: !1
            }, a.globalFilter = "", a.columnFilter = {contain: {}, exact: {}}
        }],
        link: function (c, e, f) {
            function g(a) {
    ...
    return {
        restrict: "A", scope: !1, templateUrl: "templates/vscaption.html", link: function (c, d, e) {
            ...
            function g() {
                b.isEqual(c.sort.col, "") || (c.filteredItems = o(c.filteredItems, c.sort.col, c.sort.reverse))
            }

            function h(a, d) {
                b.isObject(a) && b.isEqual(d.contain, {}) && b.isEqual(d.exact, {}) || (!b.isEqual(a, d) && q && c.execFilterAndSort(), q = !0)
            }
            ...
            function l() {
                if (c.options.filter.global || c.options.filter.column) {
                    var a = j();
                    c.options.filter.autoFilter.useAutoFilter && (a += "globalFilter", m = c.$watch(a, h))
                }
                c.options.filter.global && (n = c.$watch("filterFocus", i))
            }

            c.filterFocus = !1;
            var m = null, n = null, o = a("orderBy"), p = a("filter"), q = !0;
            c.filterBtnClick = function (a) {
                ...
                c.extDataPagination ? c.paginationOperation(c.config.EXT_FLT) : (c.execFilter(), g(), b.paginatorEvent(c))
            }, c.resetFilter = function (a) {
                q = a, c.globalFilter = "", k(c.columnFilter.contain), k(c.columnFilter.exact), !c.options.filter.autoFilter.useAutoFilter && a && c.execFilterAndSort()
            }, c.sortByCol = function (a, d) {
                a.stopPropagation(), c.checkEvent(a) && (b.isEqual(c.sort.col, d) ? c.sort.reverse = !c.sort.reverse : c.sort.reverse = !1, c.sort.col = d, c.extDataPagination || (b.isEqual(d, "") && c.execFilter(), g()), c.paginationOperation(c.config.EXT_SORT))
            }, c.execFilter = function () {
                c.filteredItems = c.options.data.items, b.isEqual(c.globalFilter, "") || (c.filteredItems = p(c.filteredItems, c.globalFilter));
                var a = f(c.columnFilter.contain);
                b.isEqual(a, {}) || (c.filteredItems = p(c.filteredItems, a));
                var d = f(c.columnFilter.exact);
                b.isEqual(d, {}) || (c.filteredItems = p(c.filteredItems, d, function (a, c) {
                    return b.isEqual(a.toString(), c) || b.isEqual(c, "")
                })), c.totalCount = c.filteredItems.length
            }, c.$on("$destroy", function () {
                b.isEqual(m, null) || m(), b.isEqual(n, null) || n()
            }), l()
        }
    }
