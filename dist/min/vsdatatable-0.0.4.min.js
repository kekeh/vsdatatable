...
angular.module("vsdatatable", ["template-vsdatatable-0.0.4.html"]).constant("vsdatatableConfig", {
    ...
    restrict: "A", scope: !1, link: function (d, e, f) {
      function g() {
        e[0].scrollWidth > e[0].offsetWidth && (l = b(function () {
          c.getTemplate("vsoverlaywindow.html").then(function (b) {
  ...
  return {
    restrict: "A", scope: !1, link: function (d, e, f) {
      ...
      function m() {
        d.options.columnResize && c.getTemplate("vscolresizer.html").then(function (b) {
