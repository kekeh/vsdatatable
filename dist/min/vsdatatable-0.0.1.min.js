...
angular.module("vsdatatable", ["template-vsdatatable-0.0.1.html"]).constant("vsdatatableConfig", {
  ...
  return {
    restrict: "A", scope: {options: "=colResizer"}, link: function (e, f, g) {
      function h(a) {
      ...
      function i(a) {
        ...
        b > 0 && d < e.options.minColWidth || 0 > b && c < e.options.minColWidth || (o.css("width", c / s * 100 + "%"), p.css("width", d / s * 100 + "%"))
      }
      ...
      function m() {
        for (var b = "position:absolute;border:1px solid transparent;background-color:transparent;top:0;bottom:0;right:0;width:6px;cursor:col-resize;", c = f.children(), d = 0; d < c.length - 2; d++) {
          var g = angular.element('<div class="colresizer" ng-click="$event.stopPropagation()" style="' + b + '"></div>');
          g.on("mousedown", h);
          var i = angular.element(c[d]);
          l(i), i.append(g), a(g)(e)
        }
      }

      var n = 0, o = 0, p = 0, q = 0, r = 0, s = 0;
      e.options.enabled && c(m)
    }
  }
}]);