  ...
  return {
    ...
    link: function (d, f, g) {
      ...
      d.addRow = function () {
        ...
        d.filteredItems = b.data, d.totalCount = b.totalCount, e.isEqual(y, d.config.EXT_BTN) || e.isEqual(y, d.config.OPER_EDIT) || e.isEqual(y, d.config.EXT_SORT) || e.paginatorEvent(d)
    ...
    restrict: "A", scope: !1, link: function (c, d, e) {
      function f() {
        ...
        if (!b.isUndefined(f.filter) && !b.isUndefined(f.filter.template) && !b.isUndefined(f.filter.match)) {
          ...
          g = g.replace("COLUMN_PROP_VALUE", "columnFilter." + f.filter.match + "." + f.prop + '"');
