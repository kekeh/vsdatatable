    ...
    link: function (d, f, g) {
      ...
      function n() {
        ...
        return angular.forEach(d.options.columns, function (b) {
          e.isUndefined(b.filter) || e.isUndefined(b.filter.template) || (a += "columnFilter." + b.filter.match + "." + b.prop + " + ")
        }), a
      }
      ...
      d.addRow = function () {
        ...
        if (e.isEqual(b.indexOf("."), -1))return a[b];
        var c = b.split("."), d = angular.copy(a);
        ...
        if (!e.isUndefined(b.rules)) {
          ...
          for (var f in b.rules) {
            var g = d.getPropertyValue(a, b.rules[f].prop), h = g.toString() + b.rules[f].expression.toString();
            if (d.$eval(h)) {
              c = b.rules[f].style;
              break
            }
    ...
    restrict: "A", scope: !1, link: function (d, e, f) {
      function g() {
        ...
        if (!b.isUndefined(g.filter) && !b.isUndefined(g.filter.template) && !b.isUndefined(g.filter.match)) {
          ...
          h = h.replace(c.COLUMN_PROP_VALUE, "columnFilter." + g.filter.match + "." + g.prop + '"');
