...
angular.module("vsdatatable", ["template-vsdatatable-0.0.1.html"]).constant("vsdatatableConfig", {
  ...
  }, b.paginatorEvent = function (b, c) {
    b.$broadcast(a.PAGINATOR_EVENT, {reason: c})
  }, b
  ...
  return {
    ...
    link: function (f, g, h) {
      ...
      var z = !1, A = null, B = {}, C = null, D = null, E = null, F = c("orderBy"), G = c("filter");
      f.addRow = function () {
        B = {
        ...
        u(), f.extDataPagination ? (e.isEqual(B.oper, f.config.OPER_ADD) || e.isEqual(B.oper, f.config.OPER_DELETE)) && e.paginatorEvent(f, "") : ((e.isEqual(B.oper, f.config.OPER_ADD) || e.isEqual(B.oper, f.config.OPER_DELETE)) && f.resetFilter(), v(f.config.OPER_PHASE_END), e.isEqual(B.oper, f.config.OPER_VIEW) || l()), i(B.dataOld)
        ...
        } : {col: b, reverse: !1}, f.extDataPagination || (e.isEqual(b, "") && l(), m()), f.paginationOperation())
        ...
        f.filteredItems = b.data, f.totalCount = b.totalCount, z || (e.paginatorEvent(f, "extInit"), z = !0)
      ...
      }, f.paginationOperation = function () {
        f.extDataPagination && f.options.data.extPaginationOperationCb({
        ...
        f.extDataPagination || (l(), m()), w(!1, !1), e.paginatorEvent(f, "")
  ...
  return {
    restrict: "A", scope: !1, templateUrl: "templates/vspaginator.html", link: function (c, d, e) {
      function f(b) {
        c.extDataPagination && (a.isEqual(b, "btn_click") ? c.paginationOperation() : a.isEqual(b, "event") && (j(0, 0), c.paginationOperation()))
      }
      ...
      function i(b, d) {
        var e = 0, f = 0;
        if (b > c.paginator.visiblePageIdx)if (e = b, a.isEqual(d, c.config.PAGINATOR_BTN_LAST))f = e - r + 1; else {
          var g = k(b);
          f = a.isEqual(g, b) ? b : g
        } else if (b < c.paginator.visiblePageIdx && !a.isEqual(d, c.config.PAGINATOR_BTN_FIRST)) {
          var g = l(b);
          e = b + r - 1, f = a.isEqual(g, b) ? b : g
        }
        j(e, f)
      }

      function j(a, b) {
        c.paginator = {visiblePageIdx: a, pageFirstIdx: b}, m()
      }

      function k(a) {
        return a + r > c.totalPages ? c.totalPages - r : a
      }
      ...
      function m() {
        r = c.totalPages > q ? q : c.totalPages;
        ...
        for (var b = a; r + a > b; b++)c.paginatorButtons.push({id: b + 1, label: b + 1});
        c.options.paginator.setNavBtnVisible && c.paginatorButtons.push(c.config.PAGINATOR_BTN_NEXT_SET), c.options.paginator.pageNavBtnVisible && c.paginatorButtons.push(c.config.PAGINATOR_BTN_NEXT), c.options.paginator.allNavBtnVisible && c.paginatorButtons.push(c.config.PAGINATOR_BTN_LAST), n()
      }
      ...
      function o() {
        h(c.totalCount), j(0, 0)
      }

      function p() {
        c.pageSizeOptions = c.options.paginator.pageSizeOptions, q = c.options.paginator.buttonCount > c.config.PAGINATOR_MAX_BTN_COUNT ? c.config.PAGINATOR_MAX_BTN_COUNT : c.options.paginator.buttonCount;
        var a = 0;
        for (var b in c.pageSizeOptions)if (angular.equals(c.pageSizeOptions[b]["default"], !0)) {
          a = b;
          break
        }
        c.pageSize = c.pageSizeOptions[a], o()
      }

      c.paginator = {visiblePageIdx: 0, pageFirstIdx: 0}, c.paginatorButtons = [], c.disabledButtons = [];
      var q = 0, r = 0;
      c.pageSizeButtonClick = function (a) {
        c.pageSize = c.pageSizeOptions[c.pageSizeOptions.indexOf(a)], o(), f("btn_click")
      }, c.paginatorBtnClick = function (a, b) {
        c.isDisabledBtn(a) || (c.isNavigateBtn(a) ? g(a) : j(a.id - 1, c.paginator.pageFirstIdx, b - 2), f("btn_click"))
      ...
      }, c.$on(b.PAGINATOR_EVENT, function (b, d) {
        a.isEqual(c.extDataPagination, !0) ? a.isEqual(d.reason, "extInit") ? o() : f("event") : o()
      }), c.$on("$destroy", function () {
